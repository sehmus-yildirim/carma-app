...
void main() {
  ...
  test('theme mode is normalized, applied and persisted locally', () async {
    SharedPreferences.setMockInitialValues(<String, Object>{
      'plaqa.theme_mode': 'light',
    });

    await AppRuntimePreferences.instance.initialize();
    expect(AppRuntimePreferences.instance.materialThemeMode, ThemeMode.light);
    ...
    expect(AppRuntimePreferences.instance.materialThemeMode, ThemeMode.system);
    final preferences = await SharedPreferences.getInstance();
    expect(preferences.getString('plaqa.theme_mode'), 'system');
  });
