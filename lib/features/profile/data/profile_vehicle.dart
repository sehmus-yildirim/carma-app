...
class ProfileVehicle {
  ...
  ProfileVehicle copyWith({
    ...
    bool clearEngineDescription = false,
    int? displacementCcm,
    bool clearDisplacementCcm = false,
    int? horsepower,
    bool clearHorsepower = false,
    int? kilowatts,
    bool clearKilowatts = false,
    String? fuelType,
    ...
    return ProfileVehicle(
      ...
      engineDescription: clearEngineDescription
          ? null
          : engineDescription ?? this.engineDescription,
      ...
      hsn: clearHsn ? null : hsn ?? this.hsn,
      tsn: clearTsn ? null : tsn ?? this.tsn,
