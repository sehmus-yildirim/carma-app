...
- Nur die echte App-Oberflaeche im isolierten Store-Screenshot-Modus aufnehmen. Der Modus ersetzt ausschliesslich personenbezogene Demoangaben und ist in normalen Debug- und Release-Builds deaktiviert.
...
- Anzeigename: `Plaqa Nutzer`.
- Abgekuerzter Anzeigename: `Plaqa N.`.
- Isoliertes Testkennzeichen: `HH-PQ 2026`.
...
- Screenshot-Modus nur lokal mit `PLAQA_STORE_SCREENSHOTS=true` aktivieren; niemals in das Release-AAB uebernehmen.
...
- Demo-Zustand: Testkennzeichen `HH-PQ 2026`; neutraler Kontaktgrund; keine private Halterinformation.
...
- Demo-Zustand: `Plaqa Nutzer` beziehungsweise `Plaqa N.`, Testkennzeichen `HH-PQ 2026`, generisches Hauptfahrzeug und mehrere neutrale Beitraege.
